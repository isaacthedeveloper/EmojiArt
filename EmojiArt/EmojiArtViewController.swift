    ...
    
{
    ...
    var emjiArtBackgroundImage: UIImage? {
        ...
        set {
            // Sets the content size equal to the frame - good for scroll and zoom.
    ...
    // Turns this into an array of strings witht the .map closure
    ...
    @IBOutlet weak var emojiCollectionView: UICollectionView! {
        didSet {
            ...
            // Let collection view drag/drop - Dont forgt to conform to DragDelegateProtocol.
    ...
    // Makes the font work with accesibility settings in iOS
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.section == 1 {
            ...
            // Check if you can case the cell as the EmojiCollectionViewCell subclass
            if let emojiCell = cell as? EmojiCollectionViewCell {
                // If the type case was successful, setup the text - for accessibility.
    ...
    // Tells the drag system "Here is what we are dragging"
